...
public class BundleAlgorithmDetails {
    ...
    public BundleAlgorithmDetails() {
    }

    public BundleAlgorithmDetails(int id, String name, int rank, String defaultDisplayText, String customDisplayText) {
        this.id = id;
        this.name = name;
        this.rank = rank;
